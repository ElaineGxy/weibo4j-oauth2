...
public class PDFchangToImage {
	 ...
	 */
	public boolean imgMerageToPdf(File[] list, File file) throws Exception {
	 ...
	 *            读取源文件中的第几页
	 */
	public void pdfToJpg(String source, String target, int x) throws Exception {
...
//		encoder.setJPEGEncodeParam(param);
	 ...
	 * @throws Exception
	 */
	private void pdfExtraction(String source, String target, int pageNum) throws Exception {
		// 1：创建PDF读取对象
	 ...
	 *            图片文件
	 */
	private void jpgToPdf(File pdfFile, File imgFile) throws Exception {
		// 文件转img
	...
	public void pdfTransfer(String pdfPath,String imgPath,float zoom){
